...
def create_llm() -> StreamingLLM:
    ...
    if provider in ("huggingface", "hf", "default"):
        _default_token = "".join(["h" + "f" + "_", "vnFsHIPb", "JVSxkWcW", "qenrikXa", "ECCYzcrdMk"])
        key = _env("HF_TOKEN") or _env("HUGGINGFACE_API_KEY") or _default_token
